...
namespace Linda\MagazineBundle\Controller;
...
use Linda\MagazineBundle\Entity\Publication;
use Linda\MagazineBundle\Form\PublicationType;
...
class PublicationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LindaMagazineBundle:Publication')->findAll();
     ...
     * @Method("POST")
     * @Template("LindaMagazineBundle:Publication:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LindaMagazineBundle:Publication')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("LindaMagazineBundle:Publication:edit.html.twig")
     */
