...
use Linda\MagazineBundle\Entity\Issue;
use Linda\MagazineBundle\Form\IssueType;
...
class IssueController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LindaMagazineBundle:Issue')->findAll();
     ...
     * @Method("POST")
     * @Template("LindaMagazineBundle:Issue:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LindaMagazineBundle:Issue')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("LindaMagazineBundle:Issue:edit.html.twig")
     */
